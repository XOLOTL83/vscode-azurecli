...
import { HoverProvider, Hover, SnippetString, StatusBarAlignment, StatusBarItem, EventEmitter, ExtensionContext, TextDocument, TextDocumentContentProvider, TextDocumentChangeEvent, Disposable, TextEditor, Selection, languages, commands, Range, ViewColumn, Position, CancellationToken, ProviderResult, CompletionItem, CompletionList, CompletionItemKind, CompletionItemProvider, window, workspace, env, Uri, WorkspaceEdit,  } from 'vscode';
